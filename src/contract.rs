...
pub fn execute_end_bet(
    ...
    let get_fee_message = BankMsg::Send {
        ...
        amount: coins(fee.u128(), String::from("udevcore")),
    };
...
pub fn execute_up_bet(
    ...
    let denom = String::from("udevcore");
    let funds = _info
        .funds
        .iter()
    ...
    if funds.amount < Uint128::from(100000u128) {
...
pub fn execute_claim(
    ...
    let mut claim_msg = BankMsg::Send {
        ...
        amount: coins(reward.u128(), String::from("udevcore")),
    };
